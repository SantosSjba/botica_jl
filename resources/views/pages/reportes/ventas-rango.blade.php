...
<div class="min-w-0 space-y-6">
    ...
    <x-common.component-card title="Reporte de ventas" desc="Ventas por rango de fechas. Detalle por ítem de venta. Excluye anuladas.">
        <div class="space-y-4">
            <form method="get" action="{{ route('reportes.ventas.rango') }}" class="flex flex-wrap items-end gap-4">
                <div>
            ...
            <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                <table class="w-full min-w-[600px] text-left text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No hay ventas en el período seleccionado.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
