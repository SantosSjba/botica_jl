                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <form method="POST" action="{{ route('login') }}" x-data="{ loading: false }" @submit="loading = true">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400" for="usuario">
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="{{ route('login') }}" class="mb-4 block">
                            <img src="{{ asset('images/logo/logo_oficial.png') }}" alt="Botica J&amp;L" class="h-24 w-auto object-contain drop-shadow-md" />
                        </a>
