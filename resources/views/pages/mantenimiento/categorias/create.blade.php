...
<div class="min-w-0 space-y-6">
    ...
    <x-common.component-card title="Registrar Forma farmacéutica" desc="(*) Campos obligatorios">
        <form action="{{ route('mantenimiento.categorias.store') }}" method="post" class="form-ajax-submit space-y-6" x-data="{ loading: false }" @submit="loading = true">
            @csrf
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="forma_farmaceutica" name="forma_farmaceutica" value="{{ old('forma_farmaceutica') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="ff_simplificada" name="ff_simplificada" value="{{ old('ff_simplificada') }}" required
