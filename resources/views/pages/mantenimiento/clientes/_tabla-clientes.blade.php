                        ...
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <td class="whitespace-nowrap px-5 py-4 text-right sm:px-6">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form action="{{ route('mantenimiento.clientes.destroy', $c) }}" method="post" class="form-ajax-submit inline-block" data-confirm="¿Realmente desea eliminar este registro?" x-data="{ loading: false }" @submit="loading = true">
                                        @csrf
                                        @method('DELETE')
