...
<div class="min-w-0 space-y-6">
    ...
    <x-common.component-card title="Cliente / Laboratorio" desc="Listado de clientes y laboratorios. Busque, ordene por columnas o agregue nuevos registros.">
        <div class="space-y-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <form id="form-buscar-clientes" method="get" action="{{ route('mantenimiento.clientes.index') }}" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <a href="{{ route('mantenimiento.clientes.create') }}">
                    ...
                    <x-ui.button type="button" id="btn-actualizar-clientes" variant="outline" size="md" class="inline-flex items-center gap-2" title="Actualizar datos">
            ...
            <x-ui.content-loading
                wrapperId="clientes-tabla-wrapper"
                loadingId="clientes-tabla-loading"
                contentContainerId="clientes-tabla-container"
            >
...
(function() {
    ...
    var container = document.getElementById('clientes-tabla-container');
