...
<div class="min-w-0 space-y-6">
    ...
    <x-common.component-card title="Lote" desc="Listado de formas farmacéuticas. Busque, ordene por columnas o agregue nuevos registros.">
        <div class="space-y-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <form id="form-buscar-lotes" method="get" action="{{ route('mantenimiento.lotes.index') }}" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <a href="{{ route('mantenimiento.lotes.create') }}">
                    ...
                    <x-ui.button type="button" id="btn-actualizar-lotes" variant="outline" size="md" class="inline-flex items-center gap-2" title="Actualizar datos">
            ...
            <x-ui.content-loading
                wrapperId="lotes-tabla-wrapper"
                loadingId="lotes-tabla-loading"
                contentContainerId="lotes-tabla-container"
            >
                @include('pages.mantenimiento.lotes._tabla-lotes')
            </x-ui.content-loading>
        </div>
...
<script>
(function() {
    var baseUrl = @json(route('mantenimiento.lotes.index'));
    var wrapper = document.getElementById('lotes-tabla-wrapper');
    var container = document.getElementById('lotes-tabla-container');
    var loadingEl = document.getElementById('lotes-tabla-loading');
    var form = document.getElementById('form-buscar-lotes');
    ...
    function updateTabla(url, pushState) {
        ...
        fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'text/html' } })
            ...
            .then(function(html) {
                ...
                inputSort.value = u.searchParams.get('sort') || 'numero';
    ...
    document.getElementById('btn-actualizar-lotes').addEventListener('click', function() {
        aplicarBusqueda();
    });

    wrapper.addEventListener('click', function(e) {
        var a = e.target.closest('a[href*="mantenimiento/lotes"]');
        if (!a) return;
