...
<div class="min-w-0 space-y-6">
    ...
    <x-common.component-card title="Registrar Lote" desc="(*) Campos obligatorios">
        <form action="{{ route('mantenimiento.lotes.store') }}" method="post" class="form-ajax-submit space-y-6" x-data="{ loading: false }" @submit="loading = true">
            @csrf
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="numero" name="numero" value="{{ old('numero') }}" required placeholder="Ej. 001, SIN LOTE"
