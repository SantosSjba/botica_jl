...
<div class="min-w-0 space-y-6">
    ...
    <x-common.component-card title="Presentación" desc="Listado de formas farmacéuticas. Busque, ordene por columnas o agregue nuevos registros.">
        <div class="space-y-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <form id="form-buscar-presentaciones" method="get" action="{{ route('mantenimiento.presentaciones.index') }}" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <a href="{{ route('mantenimiento.presentaciones.create') }}">
                    ...
                    <x-ui.button type="button" id="btn-actualizar-presentaciones" variant="outline" size="md" class="inline-flex items-center gap-2" title="Actualizar datos">
            ...
            <x-ui.content-loading
                wrapperId="presentaciones-tabla-wrapper"
                loadingId="presentaciones-tabla-loading"
                contentContainerId="presentaciones-tabla-container"
            >
                @include('pages.mantenimiento.presentaciones._tabla-presentaciones')
            </x-ui.content-loading>
        </div>
...
<script>
(function() {
    var baseUrl = @json(route('mantenimiento.presentaciones.index'));
    var wrapper = document.getElementById('presentaciones-tabla-wrapper');
    var container = document.getElementById('presentaciones-tabla-container');
    var loadingEl = document.getElementById('presentaciones-tabla-loading');
    var form = document.getElementById('form-buscar-presentaciones');
    ...
    function updateTabla(url, pushState) {
        ...
        fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'text/html' } })
            ...
            .then(function(html) {
                ...
                inputSort.value = u.searchParams.get('sort') || 'presentacion';
    ...
    document.getElementById('btn-actualizar-presentaciones').addEventListener('click', function() {
        aplicarBusqueda();
    });

    wrapper.addEventListener('click', function(e) {
        var a = e.target.closest('a[href*="mantenimiento/presentaciones"]');
        if (!a) return;
